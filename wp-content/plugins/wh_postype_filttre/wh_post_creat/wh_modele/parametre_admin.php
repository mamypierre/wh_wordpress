...
// creation de page menu
  public function wh_add_admin_menu() {
    ...
    add_menu_page( 'creation de custom post', 'custom post', 'manage_options', 'wh_custom_post', array(
      $this,
      'wh_view_menu'
    ) );

    add_submenu_page( 'wh_custom_post', 'creation post', 'creation post', 'manage_options', 'wh_custom_post', array(
      $this,
      'wh_view_menu'
    ) );

    add_submenu_page( 'wh_custom_post', 'taxonomies', 'ajout taxonomie', 'manage_options', 'wh_taxonomie', array(
      $this,
      'wh_view_taxo'
    ) );
  }
